/* Auto-generated by genmsg_cpp for file /home/david/ros_workspace/sim/msg/TelemetryUpdate.msg */
#ifndef SIM_MESSAGE_TELEMETRYUPDATE_H
#define SIM_MESSAGE_TELEMETRYUPDATE_H
#include <string>
#include <vector>
#include <map>
#include <ostream>
...
struct TelemetryUpdate_ {
  ...
  typedef boost::shared_ptr< ::sim::TelemetryUpdate_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::sim::TelemetryUpdate_<ContainerAllocator>  const> ConstPtr;
  boost::shared_ptr<std::map<std::string, std::string> > __connection_header;
}; // struct TelemetryUpdate
typedef  ::sim::TelemetryUpdate_<std::allocator<void> > TelemetryUpdate;

typedef boost::shared_ptr< ::sim::TelemetryUpdate> TelemetryUpdatePtr;
typedef boost::shared_ptr< ::sim::TelemetryUpdate const> TelemetryUpdateConstPtr;


template<typename ContainerAllocator>
std::ostream& operator<<(std::ostream& s, const  ::sim::TelemetryUpdate_<ContainerAllocator> & v)
{
  ros::message_operations::Printer< ::sim::TelemetryUpdate_<ContainerAllocator> >::stream(s, "", v);
  return s;}
...
{
template<class ContainerAllocator> struct IsMessage< ::sim::TelemetryUpdate_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::sim::TelemetryUpdate_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
struct MD5Sum< ::sim::TelemetryUpdate_<ContainerAllocator> > {
  static const char* value() 
  {
    return "53cd950963d7a5c403c785f8c0a2ffa7";
  }

  static const char* value(const  ::sim::TelemetryUpdate_<ContainerAllocator> &) { return value(); } 
  static const uint64_t static_value1 = 0x53cd950963d7a5c4ULL;
  static const uint64_t static_value2 = 0x03c785f8c0a2ffa7ULL;
};

template<class ContainerAllocator>
struct DataType< ::sim::TelemetryUpdate_<ContainerAllocator> > {
  static const char* value() 
  {
    return "sim/TelemetryUpdate";
  }
...
template<class ContainerAllocator>
struct Definition< ::sim::TelemetryUpdate_<ContainerAllocator> > {
  static const char* value() 
  {
...
template<class ContainerAllocator> struct Serializer< ::sim::TelemetryUpdate_<ContainerAllocator> >
{
...
template<class ContainerAllocator>
struct Printer< ::sim::TelemetryUpdate_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const  ::sim::TelemetryUpdate_<ContainerAllocator> & v) 
  {
...
#endif // SIM_MESSAGE_TELEMETRYUPDATE_H
